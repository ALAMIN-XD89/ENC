...
\033[1;92m[Programmed By Alamin Hossain Robin]
\033[1;92m[Facebook : Md. Alamin Islam
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[ALAMIN] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/atalamin] ')
    print('\n[01] Main Menu')
    print('[02] Exit')
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by ALAMIN ( SKB)\n# Github- https://github.com/atalamin\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by SKB( ALAMIN)\n# Github- https://github.com/atalamin\n\n"+filedata)
    os.remove(".temp2")
    sprint(success + out_file + " saved in "+pwd)
    mover(out_file)
